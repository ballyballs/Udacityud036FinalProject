...
class Movie_Details():
    ...
    the Movie_Details class sets up a connection to the movieDb and searches for the movie using the title and release date passed into the constructor
    ...
    def __init__(self, movie_title, movie_release_date):
        ...
        sets up the connection and sets some object level variables to be used in the methods
        """
        ...
        response=self.moviedb_search.movie(query=movie_title, year=movie_release_date)
